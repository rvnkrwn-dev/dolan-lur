...
const wisata = ref([])  // This will hold the fetched wisata data
...
const fetchWisata = async () => {
  ...
  try {
    ...
    // Assuming the response data structure is an array of wisata objects
    wisata.value = data ?? []  // Store fetched data into `wisata`
  } catch (err) {
