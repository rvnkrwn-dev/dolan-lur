<template>
  <div class="mt-20 max-w-7xl mx-auto px-4">
    ...
    <div v-else-if="error || wisata.length === 0" class="p-4 text-center text-gray-500 h-32 flex items-center justify-center">
      <p>Tidak ada data</p>
    </div>
    <div v-else class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
      <NuxtLink v-for="item in wisata" :key="item.id"
        ...
        <div class="relative h-52">
          ...
          <img :src="'/api/images/' + item.gambar[0].filename" :alt="item.nama"
