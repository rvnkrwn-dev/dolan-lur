<template>
  <div class="w-full bg-white rounded-lg shadow-md">
    <client-only>
      <div v-if="images.length > 0" data-hs-carousel='{
        ...
        <div class="hs-carousel relative overflow-hidden w-full min-h-64 bg-white rounded-lg">
          <div class="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
            <div v-for="img in images" :key="img.id" class="hs-carousel-slide">
              <div class="flex justify-center h-full bg-gray-100 p-6">
                <img :src="img.secure_url" alt="carousel image" class="object-cover"/>
              </div>
            </div>
